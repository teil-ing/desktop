...
export const icons = {
  ...
  // Record variants: the capture glyph plus a filled dot.
  recordRegion: svg('<path d="M6 2v14a2 2 0 0 0 2 2h14"/><path d="M18 22V8a2 2 0 0 0-2-2H2"/><circle cx="12" cy="12" r="3" fill="currentColor" stroke="none"/>'),
  recordFullscreen: svg('<rect x="2" y="4" width="20" height="13" rx="2"/><path d="M8 21h8"/><circle cx="12" cy="10.5" r="3" fill="currentColor" stroke="none"/>'),
  recordWindow: svg('<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 9h18"/><circle cx="12" cy="14.5" r="3" fill="currentColor" stroke="none"/>'),
  ...
  film: svg('<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 4v16"/><path d="M17 4v16"/><path d="M3 9h4"/><path d="M3 15h4"/><path d="M17 9h4"/><path d="M17 15h4"/>'),
  ...
  // Arrow into a tray → save the original to disk.
  save: svg('<path d="M12 3v10"/><path d="m8 9 4 4 4-4"/><path d="M4 15v3a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-3"/>'),
